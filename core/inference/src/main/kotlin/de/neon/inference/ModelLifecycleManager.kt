...
class ModelLifecycleManager(
    ...
    suspend fun ensureLoaded(model: ModelSpec): Result = mutex.withLock {
        ...
        if (model.sizeBytes > memoryBudgetBytes) {
            return Result.TooLarge(model, memoryBudgetBytes)
        }
    ...
    companion object {
        /**
         * Fünf Gigabyte. Von 16 GB gehen etwa 6 GB an One UI; der Rest muss auch noch für
         * Audio, Spracherkennung und die App selbst reichen.
         */
        const val DEFAULT_BUDGET_BYTES = 5L * 1024 * 1024 * 1024
